...
Fire=readtable('TrainSet2_fire.csv');
...
for i=1:n
    ...
    f=table2array(f);
    La_Xls(i,1)=str2double(cell2mat((f(21,12))));
    Lo_Xls(i,1)=str2double(cell2mat((f(21,13))));     
    qiwen(i,1)=(str2double(cell2mat((f(21,7))))-32)*5/9;
end
...
for i=1:n
    ...
    La_Xls(i,1)=str2double(cell2mat((f(21,12))));
    Lo_Xls(i,1)=str2double(cell2mat((f(21,13))));   
    Td=(str2double(cell2mat((f(21,17))))-32)*5/9;
    T=(str2double(cell2mat((f(21,7))))-32)*5/9;
...
for i=1:n
    ...
    La_Xls(i,1)=str2double(cell2mat((f(21,12))));
    Lo_Xls(i,1)=str2double(cell2mat((f(21,13))));   
    fengsu(i,1)=str2double(cell2mat((f(21,5))));
end
...
%%Altitude
[P,R]=geotiffread('Train2_Altitude.tif');
P=imresize(P,[2123,2163]);
...
La=LaB:R.CellExtentInLatitude*10:LaE-R.CellExtentInLatitude;
La=La';
Slope_Latitude=repelem(La,1,2163);
Lo=LoB:R.CellExtentInLongitude*10:LoE-R.CellExtentInLongitude;
Slope_Longitude=repelem(Lo,2123,1);
